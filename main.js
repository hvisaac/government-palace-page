...
const routes = [
    {
        path: 'home',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_pages_street-lighting-report_street-lighting-report_module_ts"), __webpack_require__.e("common"), __webpack_require__.e("src_app_pages_home_home_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/home/home.module */ 7994)).then(m => m.HomePageModule)
    },
    {
        path: '',
        redirectTo: 'login',
    ...
    {
        path: 'register-user',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_register-user_register-user_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/register-user/register-user.module */ 990)).then(m => m.RegisterUserPageModule)
    },
    {
        path: 'street-lighting-report',
        loadChildren: () => __webpack_require__.e(/*! import() */ "default-src_app_pages_street-lighting-report_street-lighting-report_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/street-lighting-report/street-lighting-report.module */ 157)).then(m => m.StreetLightingReportPageModule)
    },
    {
        path: 'water',
        loadChildren: () => __webpack_require__.e(/*! import() */ "common").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/water/water.module */ 5858)).then(m => m.WaterPageModule)
    },
    {
        path: 'galery',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_galery_galery_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/galery/galery.module */ 5281)).then(m => m.GaleryPageModule)
    }
];
...
let AppComponent = class AppComponent {
    constructor() {
        _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_2__.StatusBar.setOverlaysWebView({ overlay: true }).catch(() => { });
        ;
    ...
    hideStatusBar() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            yield _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_2__.StatusBar.hide();
        });
    }
    ;
};
